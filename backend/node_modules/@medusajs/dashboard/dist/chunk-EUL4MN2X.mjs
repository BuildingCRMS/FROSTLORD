          ...
          children: [
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-HDWVZKEQ.mjs")
                    },
                    {
                      path: "import",
                ...
                },
                {
                  ...
                  errorElement: /* @__PURE__ */ jsx18(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-GFT3JDWD.mjs");
                    return {
                      Component: Outlet4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-GFT3JDWD.mjs"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-CD6KZJXT.mjs")
                        },
                        {
                          path: "edit-variant",
                        ...
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-TNJP7QE6.mjs")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-MJLQKEHF.mjs")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-NQUGQ2JY.mjs")
                        },
                        {
                          path: "media",
            ...
            },
            {
              ...
              children: [
                ...
                {
                  path: "create",
                  lazy: () => import("./promotion-create-UUB7JXGF.mjs")
                },
                {
                  path: ":id",
                  lazy: async () => {
                  ...
                  children: [
                    ...
                    {
                      path: ":ruleType/edit",
                      lazy: () => import("./edit-rules-PSYI3SVJ.mjs")
                    }
                  ]
                }
              ]
          ...
          children: [
              ...
              children: [
                ...
                },
                {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./region-edit-7LERS6BF.mjs")
                    },
                    {
                      path: "countries/add",
            ...
            },
            {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./store-edit-HHK5OTJA.mjs")
                },
                {
                  path: "currencies",
                              ...
                              children: [
                                ...
                                },
                                {
                                  ...
                                  children: [
                                    {
                                      path: "edit",
                                      lazy: () => import("./location-service-zone-shipping-option-edit-CAIULPE6.mjs")
                                    },
                                    {
                                      path: "pricing",
