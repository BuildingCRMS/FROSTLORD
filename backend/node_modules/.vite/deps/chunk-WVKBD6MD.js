...
var useSelectContext = ctx6.useContext;
var useSelectScopedContext = ctx6.useScopedContext;
var useSelectProviderContext = ctx6.useProviderContext;
var SelectContextProvider = ctx6.ContextProvider;
var SelectScopedContextProvider = ctx6.ScopedContextProvider;
var SelectItemCheckedContext = (0, import_react5.createContext)(false);
var SelectHeadingContext = (0, import_react5.createContext)(null);
    ...
    props = __spreadProps(__spreadValues({}, props), {
      render: (0, import_jsx_runtime3.jsx)(
        ...
        __spreadProps(__spreadValues({}, defaultProps), {
          render: store.combobox && store.composite !== store.combobox ? (0, import_jsx_runtime3.jsx)(CompositeItem, __spreadProps(__spreadValues({}, defaultProps), { store: store.combobox })) : defaultProps.render
        })
      )
    });
  }
...
var useComposite = createHook(
  function useComposite2(_a) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime5.jsx)(CompositeContextProvider, { value: store, children: element }),
      [store]
    );
...
var useTabList = createHook(
  function useTabList2(_a) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime6.jsx)(TabScopedContextProvider, { value: store, children: element }),
      [store]
    );
    if (store.composite) {
...
var useDisclosureContent = createHook(function useDisclosureContent2(_a) {
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime7.jsx)(DialogScopedContextProvider, { value: store, children: element }),
    [store]
  );
...
var DisclosureContent = forwardRef2(function DisclosureContent2(_a) {
  ...
  return (0, import_jsx_runtime7.jsx)(DisclosureContentImpl, __spreadValues({}, props));
});
...
var useTabPanel = createHook(
  function useTabPanel2(_a) {
    ...
    const scrollPositionRef = (0, import_react16.useRef)(
      /* @__PURE__ */ new Map()
    );
    ...
    const [hasTabbableChildren, setHasTabbableChildren] = (0, import_react16.useState)(false);
    (0, import_react16.useEffect)(() => {
      const element = ref.current;
      if (!element) return;
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime8.jsx)(TabScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = __spreadProps(__spreadValues({
      id,
...
function usePreviousMouseDownRef(enabled) {
  const previousMouseDownRef = (0, import_react22.useRef)();
...
function DialogBackdrop({
  ...
  if ((0, import_react27.isValidElement)(backdrop)) {
    return (0, import_jsx_runtime15.jsx)(Role, __spreadProps(__spreadValues({}, props), { render: backdrop }));
  }
  const Component = typeof backdrop !== "boolean" ? backdrop : "div";
  return (0, import_jsx_runtime15.jsx)(Role, __spreadProps(__spreadValues({}, props), { render: (0, import_jsx_runtime15.jsx)(Component, {}) }));
}
...
var usePopoverArrow = createHook(
  function usePopoverArrow2(_a) {
    ...
    const borderWidth = (0, import_react33.useMemo)(() => {
    ...
    const children3 = (0, import_react33.useMemo)(
      () => (0, import_jsx_runtime21.jsx)("svg", { display: "block", viewBox: "0 0 30 30", children: (0, import_jsx_runtime21.jsxs)("g", { transform, children: [
        (0, import_jsx_runtime21.jsx)("path", { fill: "none", d: POPOVER_ARROW_PATH, mask: `url(#${maskId})` }),
        (0, import_jsx_runtime21.jsx)("path", { stroke: "none", d: POPOVER_ARROW_PATH }),
        (0, import_jsx_runtime21.jsx)("mask", { id: maskId, maskUnits: "userSpaceOnUse", children: (0, import_jsx_runtime21.jsx)(
          "rect",
          {
            x: "-15",
            y: "0",
...
var usePopoverDisclosureArrow = createHook(function usePopoverDisclosureArrow2(_a) {
  ...
  const children3 = (0, import_react36.useMemo)(
...
var useButton = createHook(
  function useButton2(props) {
    ...
    const tagName = useTagName(ref, TagName36);
    const [isNativeButton, setIsNativeButton] = (0, import_react37.useState)(
...
var usePopoverDisclosure = createHook(function usePopoverDisclosure2(_a) {
  ...
  props = useWrapElement(
    props,
    (element) => (0, import_jsx_runtime26.jsx)(PopoverScopedContextProvider, { value: store, children: element }),
    [store]
  );
  props = __spreadProps(__spreadValues({}, props), {
    onClick
    ...
    const children3 = (0, import_react39.useMemo)(
      () => (0, import_jsx_runtime27.jsxs)(
        "svg",
        {
          ...
          width: "1em",
          children: [
            (0, import_jsx_runtime27.jsx)("line", { x1: "4", y1: "4", x2: "12", y2: "12" }),
            (0, import_jsx_runtime27.jsx)("line", { x1: "4", y1: "12", x2: "12", y2: "4" })
          ]
        }
      ),
      []
...
var useHeading = createHook(
  function useHeading2(props) {
    ...
    props = __spreadProps(__spreadValues({
      render: (0, import_jsx_runtime28.jsx)(Element, {}),
...
var useRadioGroup = createHook(
  function useRadioGroup2(_a) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime30.jsx)(RadioScopedContextProvider, { value: store, children: element }),
      [store]
    );
    props = __spreadValues({
      role: "radiogroup"
...
var useGroupLabel = createHook(
  function useGroupLabel2(props) {
    const setLabelId = (0, import_react46.useContext)(GroupLabelContext);
    const id = useId(props.id);
    useSafeLayoutEffect(() => {
...
var useGroup = createHook(
  function useGroup2(props) {
    const [labelId, setLabelId] = (0, import_react47.useState)();
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime33.jsx)(GroupLabelContext.Provider, { value: setLabelId, children: element }),
      []
    );
    props = __spreadValues({
      role: "group",
...
var CheckboxCheckedContext = (0, import_react49.createContext)(false);
...
var useCheckboxCheck = createHook(
  function useCheckboxCheck2(_a) {
    ...
    const context = (0, import_react50.useContext)(CheckboxCheckedContext);
...
var useSelectItemCheck = createHook(
  function useSelectItemCheck2(_a) {
    var _b = _a, { store, checked } = _b, props = __objRest(_b, ["store", "checked"]);
    const context = (0, import_react51.useContext)(SelectItemCheckedContext);
    checked = checked != null ? checked : context;
...
var useCompositeHover = createHook(
  function useCompositeHover2(_a) {
    ...
    const ref = (0, import_react52.useCallback)((element) => {
      if (!element) return;
...
var useSelectItem = createHook(
  function useSelectItem2(_a) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime35.jsx)(SelectItemCheckedContext.Provider, { value: selected != null ? selected : false, children: element }),
      [selected]
    );
    props = __spreadProps(__spreadValues({
      id,
...
var useSelectList = createHook(
  function useSelectList2(_a) {
    ...
    props = useWrapElement(
      props,
      (element2) => (0, import_jsx_runtime36.jsx)(SelectScopedContextProvider, { value: store, children: (0, import_jsx_runtime36.jsx)(SelectListContext.Provider, { value: setChildStore, children: (0, import_jsx_runtime36.jsx)(SelectHeadingContext.Provider, { value: headingContextValue, children: element2 }) }) }),
...
var useForm = createHook(function useForm2(_a) {
  ...
  const [shouldFocusOnSubmit, setShouldFocusOnSubmit] = (0, import_react58.useState)(false);
  (0, import_react58.useEffect)(() => {
...
var useFormControl = createHook(
  function useFormControl2(_a) {
    ...
    const getItem = (0, import_react59.useCallback)(
      (item) => {
...
var useCheckbox = createHook(
  function useCheckbox2(_a) {
    ...
    store = store || context;
    const [_checked, setChecked] = (0, import_react60.useState)(defaultChecked != null ? defaultChecked : false);
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime41.jsx)(CheckboxCheckedContext.Provider, { value: isChecked, children: element }),
      [isChecked]
    );
    props = __spreadProps(__spreadValues({
...
var useFormLabel = createHook(
  function useFormLabel2(_a) {
    ...
    const name = `${nameProp}`;
    const getItem = (0, import_react63.useCallback)(
      (item) => {
    ...
    props = __spreadProps(__spreadValues({
      id,
      render: isNativeLabel ? (0, import_jsx_runtime42.jsx)("label", {}) : (0, import_jsx_runtime42.jsx)("span", {}),
...
function useAriaLabelledBy(_a) {
  var _b = _a, { store } = _b, props = __objRest(_b, ["store"]);
  const [id, setId] = (0, import_react68.useState)(void 0);
  const label = props["aria-label"];
...
var useMenuList = createHook(
  function useMenuList2(_a) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime45.jsx)(MenuScopedContextProvider, { value: store, children: element }),
      [store]
    );
...
var useMenu = createHook(function useMenu2(_a) {
  ...
  props = menuListProps;
  const [initialFocusRef, setInitialFocusRef] = (0, import_react69.useState)();
  ...
  (0, import_react69.useEffect)(() => {
    ...
    setInitialFocusRef((prevInitialFocusRef) => {
      ...
      const ref2 = (0, import_react69.createRef)();
      switch (initialFocus) {
        case "first":
  ...
  const preserveTabOrderAnchor = (0, import_react69.useMemo)(() => {
...
var useCollection = createHook(
  function useCollection2(_a) {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime51.jsx)(CollectionScopedContextProvider, { value: store, children: element }),
      [store]
    );
    return removeUndefinedValues(props);
  }
...
var TagRemoveIdContext = (0, import_react76.createContext)(
  null
);
...
var useCombobox = createHook(
  function useCombobox2(_a) {
    ...
    const [canInline, setCanInline] = (0, import_react77.useState)(inline);
    useUpdateLayoutEffect(() => {
      if (!inline) return;
      setCanInline(true);
    }, [inline]);
    const storeValue = store.useState("value");
    const prevSelectedValueRef = (0, import_react77.useRef)();
    ...
    const scrollingElementRef = (0, import_react77.useRef)(null);
...
function ComboboxProvider(props = {}) {
  ...
  return (0, import_jsx_runtime53.jsx)(ComboboxContextProvider, { value: store, children: props.children });
}
  ...
  function useComboboxCancel2(_a) {
    ...
    props = useWrapElement(
      ...
      (element) => {
        ...
        if (empty) return (0, import_jsx_runtime54.jsx)(import_react78.Fragment, {});
        return element;
      },
      [hideWhenEmpty, empty]
    );
...
function splitValue(itemValue, userValue) {
  ...
  const parts = [];
  const span = (value, autocomplete = false) => (0, import_jsx_runtime56.jsx)(
    "span",
    {
...
var useComboboxItem = createHook(
  function useComboboxItem2(_a) {
    ...
    const getItem = (0, import_react81.useCallback)(
      (item) => {
    ...
    props = useWrapElement(
      props,
      (element) => (0, import_jsx_runtime57.jsx)(ComboboxItemValueContext.Provider, { value, children: (0, import_jsx_runtime57.jsx)(ComboboxItemCheckedContext.Provider, { value: selected != null ? selected : false, children: element }) }),
      [value, selected]
    );
    const popupRole = (0, import_react81.useContext)(ComboboxListRoleContext);
    props = __spreadProps(__spreadValues({
...
var useComboboxList = createHook(
  function useComboboxList2(_a) {
    ...
    const [hasListboxInside, setHasListboxInside] = (0, import_react82.useState)(false);
    const contentElement = store.useState("contentElement");
    useSafeLayoutEffect(() => {
      if (!mounted) return;
      const element = ref.current;
...
var useComboboxPopover = createHook(
  function useComboboxPopover2(_a) {
    ...
    const baseElement = store.useState("baseElement");
    const hiddenByClickOutsideRef = (0, import_react83.useRef)(false);
...
//# sourceMappingURL=chunk-WVKBD6MD.js.map
