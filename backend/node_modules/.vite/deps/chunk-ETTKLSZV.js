import {
  ...
  taxRegionLoader
} from "./chunk-HWNV5K42.js";
import {
  isFetchError
} from "./chunk-TCAPNIAL.js";
import {
  useReturnReasons
} from "./chunk-DVYK3VDX.js";
import {
  ProgressBar
...
import {
  FilePreview
} from "./chunk-Q6LK2N6H.js";
import {
  ConditionalTooltip
} from "./chunk-HIRVG5HY.js";
import {
  we
} from "./chunk-E72KDEXZ.js";
import {
  formatDistance
...
import {
  ...
  useProductTags,
  useVariants
} from "./chunk-XLJ6ICJ6.js";
import {
  useLogout
} from "./chunk-R3BVY4FC.js";
import {
  useApiKeys
} from "./chunk-HC3T7OYA.js";
import {
  useTaxRegions
...
import {
  useShippingProfiles
} from "./chunk-TPHNIYVN.js";
import {
  useMe,
  useUsers
} from "./chunk-K5DSQLGH.js";
import {
  usePriceLists
} from "./chunk-MJ4XXNHE.js";
import {
  useCustomerGroups,
  useCustomers
} from "./chunk-FZ5DZU53.js";
import {
  useCollections
...
import {
  useStockLocations
} from "./chunk-4FJ2IEZ6.js";
import {
  useOrders
} from "./chunk-UKRVZK4B.js";
import {
  useProductCategories
} from "./chunk-LNFLNDVO.js";
import {
  useStore
} from "./chunk-LYFHXFNX.js";
import {
  useRegions
} from "./chunk-K7ZSLX65.js";
import {
  useSalesChannels
} from "./chunk-GZ2UWOV6.js";
import {
  useInventoryItems,
  useProducts
...
// node_modules/@medusajs/dashboard/dist/chunk-EUL4MN2X.mjs
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-list-ZE7FJ4LT-4IMZ247C.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-create-HDWVZKEQ-UYTUNLV4.js")
                    },
                    {
                      path: "import",
                      lazy: () => import("./product-import-R7E7AX6R-U5LDA7JV.js")
                    },
                    {
                      path: "export",
                      lazy: () => import("./product-export-S544QXRJ-T3IE44VF.js")
                    }
                  ]
                },
                {
                  ...
                  errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
                  lazy: async () => {
                    const { Breadcrumb, loader } = await import("./product-detail-GFT3JDWD-SQ7OH2AT.js");
                    return {
                      Component: Outlet,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./product-detail-GFT3JDWD-SQ7OH2AT.js"),
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./product-edit-CD6KZJXT-GLMPAU7P.js")
                        },
                        {
                          path: "edit-variant",
                          lazy: () => import("./product-variant-edit-FUU2DGZX-PZOZHCZ2.js")
                        },
                        {
                          path: "sales-channels",
                          lazy: () => import("./product-sales-channels-DCQOHEYB-KTX6MEVY.js")
                        },
                        {
                          path: "attributes",
                          lazy: () => import("./product-attributes-TNJP7QE6-QHB626RZ.js")
                        },
                        {
                          path: "organization",
                          lazy: () => import("./product-organization-MJLQKEHF-H3OFRRWQ.js")
                        },
                        {
                          path: "shipping-profile",
                          lazy: () => import("./product-shipping-profile-NQUGQ2JY-QSPNT3YZ.js")
                        },
                        {
                          path: "media",
                          lazy: () => import("./product-media-JSRNWKCA-4TVZKGUY.js")
                        },
                        {
                          path: "prices",
                          lazy: () => import("./product-prices-6GQXKVKM-R5UMUYVF.js")
                        },
                        {
                          path: "options/create",
                          lazy: () => import("./product-create-option-XBN5ESJQ-SJG2Z2E5.js")
                        },
                        {
                          path: "options/:option_id/edit",
                          lazy: () => import("./product-edit-option-EPX6OM35-EAJHLXOA.js")
                        },
                        {
                          path: "variants/create",
                          lazy: () => import("./product-create-variant-HAX7KEPH-G5NDND7L.js")
                        },
                        {
                          path: "stock",
                          lazy: () => import("./product-stock-3RDIBMGD-J2YNDAEF.js")
                        },
                        {
                          path: "metadata/edit",
                          lazy: () => import("./product-metadata-PTNUGYZW-NCELZTST.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./product-variant-detail-CJDRLDMN-ZHKCKLDG.js");
                        return {
                      ...
                      children: [
                        ...
                        {
                          path: "manage-items",
                          lazy: () => import("./product-variant-manage-inventory-items-UXTZGHEZ-V2D44B35.js")
                        },
                        {
                          path: "metadata/edit",
                          lazy: () => import("./product-variant-metadata-2RKINR5L-IBU42JM7.js")
                        }
                      ]
                    }
                  ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./category-list-4LUZATDD-SLXVFRA2.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./category-create-OL37ATOA-OUZYBBKC.js")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-MZUOSX6P-QYFZD2SA.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./category-detail-JHSAREY7-6NDA57VZ.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./category-edit-CPUTD66C-EQZZJXQ4.js")
                    },
                    {
                      path: "products",
                      lazy: () => import("./category-products-7VQCC5U3-A6ZV7NPI.js")
                    },
                    {
                      path: "organize",
                      lazy: () => import("./category-organize-MZUOSX6P-QYFZD2SA.js")
                    ...
                    {
                      path: "metadata/edit",
                      lazy: () => import("./categories-metadata-W2CESHV5-5743HD3M.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./order-list-XZ4KYLON-TNX2TZZT.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./order-detail-NGSH52Z4-3SYJGOV5.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "fulfillment",
                      lazy: () => import("./order-create-fulfillment-IFN7S65X-WTPFWLLR.js")
                    },
                    {
                      path: "returns/:return_id/receive",
                      lazy: () => import("./order-receive-return-YAYMPZJW-AYR6SQMU.js")
                    },
                    {
                      path: "allocate-items",
                      lazy: () => import("./order-allocate-items-TD4OOYWA-EC72POZV.js")
                    },
                    {
                      path: ":f_id/create-shipment",
                      lazy: () => import("./order-create-shipment-XRXASEDU-3GQBRSL7.js")
                    },
                    {
                      path: "returns",
                      lazy: () => import("./order-create-return-BA4A2GSJ-RKFXU6HV.js")
                    },
                    {
                      path: "claims",
                      lazy: () => import("./order-create-claim-VMWI3GDO-7N5WEXLB.js")
                    },
                    {
                      path: "exchanges",
                      lazy: () => import("./order-create-exchange-BEX6IWTR-U2ZRWB4E.js")
                    },
                    {
                      path: "edits",
                      lazy: () => import("./order-create-edit-Y6BN5MCA-ZDB4CXFI.js")
                    },
                    {
                      path: "refund",
                      lazy: () => import("./order-create-refund-BD3RY5DM-EZ46N5RR.js")
                    },
                    {
                      path: "transfer",
                      lazy: () => import("./order-request-transfer-XJNDDA4G-RIMXYCR3.js")
                    },
                    {
                      path: "email",
                      lazy: () => import("./order-edit-email-GSXMMPSB-RKIJ3BXW.js")
                    },
                    {
                      path: "shipping-address",
                      lazy: () => import("./order-edit-shipping-address-Y7ND5YVE-4PBF6GTK.js")
                    },
                    {
                      path: "billing-address",
                      lazy: () => import("./order-edit-billing-address-WJD5VAAS-UO3G6DW5.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./order-metadata-MWSSDBMQ-DAQNIRKN.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./promotion-list-V4JIGJW5-ZXORE5FX.js")
                },
                {
                  path: "create",
                  lazy: () => import("./promotion-create-UUB7JXGF-E62UD6DR.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./promotion-detail-LDIKGJBZ-IL363FBV.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./promotion-edit-details-YICY5ZJL-X5Y44MDL.js")
                    },
                    {
                      path: "add-to-campaign",
                      lazy: () => import("./promotion-add-campaign-4MRPKION-JE4OOBS5.js")
                    },
                    {
                      path: ":ruleType/edit",
                      lazy: () => import("./edit-rules-PSYI3SVJ-K4QYY7SH.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./campaign-list-2L43M6VK-MBWJH6A7.js"),
                  children: []
                },
                {
                  path: "create",
                  lazy: () => import("./campaign-create-AOJJFFCT-FEOJBBT6.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./campaign-detail-LURHAF6U-TVOCEJ4Y.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./campaign-edit-TY5I5ZMS-IERPXNS4.js")
                    },
                    {
                      path: "configuration",
                      lazy: () => import("./campaign-configuration-T7U7VQ63-7O2BZTAR.js")
                    },
                    {
                      path: "edit-budget",
                      lazy: () => import("./campaign-budget-edit-XG46WNQN-6ZHDVO76.js")
                    },
                    {
                      path: "add-promotions",
                      lazy: () => import("./add-campaign-promotions-56AKNIWT-OMBQJGJ7.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./collection-list-4G6V343G-IKBSRBZ7.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./collection-create-BWDX2T4L-LZBBFEII.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./collection-detail-SFZDN2RS-SMIEJGDI.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./collection-edit-2ZP3IMAP-QLZIKWEY.js")
                    },
                    {
                      path: "products",
                      lazy: () => import("./collection-add-products-LVH7EYET-DJB2UWT7.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./collection-metadata-VADZZZ7U-7Z4FKEKV.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./price-list-list-SN5U2FL3-4YLJZWNF.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./price-list-create-LT4D6HY3-L2E4JUA6.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./price-list-detail-76BYWE7A-F5QP5X7X.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./price-list-edit-LTN23QHD-MQKXPKRK.js")
                    },
                    {
                      path: "configuration",
                      lazy: () => import("./price-list-configuration-5Q6DGDYH-3X5ZMYKG.js")
                    },
                    {
                      path: "products/add",
                      lazy: () => import("./price-list-prices-add-44A6F6W6-4SPBYAEH.js")
                    },
                    {
                      path: "products/edit",
                      lazy: () => import("./price-list-prices-edit-ADO2CCEW-QQNLIZLZ.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-list-KYO4ZLSU-EYR6DUN5.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./customer-create-BIM4YFGV-EQT4C255.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./customer-detail-VBMZUWKA-RWGB2QS6.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./customer-edit-FJNPYFCK-63RE4RUW.js")
                    },
                    {
                      path: "create-address",
                      lazy: () => import("./customer-create-address-TPSDYZBN-RNVNGNMN.js")
                    },
                    {
                      path: "add-customer-groups",
                      lazy: () => import("./customers-add-customer-group-NPJWG37O-EUIHDQAP.js")
                    },
                    {
                    ...
                    {
                      path: "metadata/edit",
                      lazy: () => import("./customer-metadata-5NPUMPZ2-6FLO3YNW.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./customer-group-list-CXR5US56-2RBTFZ3O.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./customer-group-create-7X4TZR54-QBJV6FLA.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./customer-group-detail-LFS6WFVS-CBHEII2I.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./customer-group-edit-J3AGQAAF-L3FA6IEL.js")
                    },
                    {
                      path: "add-customers",
                      lazy: () => import("./customer-group-add-customers-Q6DGE5DV-GYHXG2CZ.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./customer-group-metadata-UPAPULMF-ED4Y5YBA.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./reservation-list-7MX4KHR7-FXOGCCBM.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./reservation-create-2BJZ5PVC-ZMOZ3EW7.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./reservation-detail-ZRLQZHKV-SQOT5VD3.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./edit-reservation-OEYCFX5G-AFXG3FZD.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./reservation-metadata-2IEGRN5N-SJMZFRKQ.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./inventory-list-AI6CCLQQ-YI7FRGMV.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./inventory-create-DR5CTETM-VORQGC6N.js")
                    },
                    {
                      path: "stock",
                      lazy: () => import("./inventory-stock-Y3BLFXTS-LZIG5ECU.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./inventory-detail-5T25FK54-CDWHJCIA.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./edit-inventory-item-C5LOBVNU-A6HM7O7A.js")
                    },
                    {
                      path: "attributes",
                      lazy: () => import("./edit-inventory-item-attributes-3PFNDKPM-F62YUVXN.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./inventory-metadata-E5XGI7DQ-KJHXCEOE.js")
                    },
                    {
                      path: "locations",
                      lazy: () => import("./manage-locations-PIPXIO4Z-BU4GBQN7.js")
                    },
                    {
                      path: "locations/:location_id",
                      lazy: () => import("./adjust-inventory-FL2YMCXV-XJ3NB5FN.js")
                    }
                  ]
                }
              ]
      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              path: "profile",
              errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
              lazy: () => import("./profile-detail-ROG22HHL-ZAJEQIIJ.js"),
              handle: {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./profile-edit-HSUQIQQH-7DJSZH3X.js")
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./region-list-2YVIIJSN-KSGAQMRS.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./region-create-KJHEJMMP-M3QHNWYL.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./region-detail-UGQRJJHW-Z2ZAZ3U5.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./region-edit-7LERS6BF-7URE6J3Y.js")
                    },
                    {
                      path: "countries/add",
                      lazy: () => import("./region-add-countries-M7O3RG2T-KVDIYL3K.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./region-metadata-AHFTUQ6R-TVVVVM3S.js")
                    }
                  ]
                }
              ]
            },
            {
              path: "store",
              errorElement: (0, import_jsx_runtime18.jsx)(ErrorBoundary, {}),
              lazy: () => import("./store-detail-575XDHHQ-5UC5UQZ2.js"),
              handle: {
              ...
              children: [
                {
                  path: "edit",
                  lazy: () => import("./store-edit-HHK5OTJA-Q6FG6BWC.js")
                },
                {
                  path: "currencies",
                  lazy: () => import("./store-add-currencies-ETHNDZOX-BEA4BDMN.js")
                },
                {
                  path: "metadata/edit",
                  lazy: () => import("./store-metadata-5Z3XHK3E-KEPP4XJI.js")
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./user-list-PIQLQBQE-D7D7UKBM.js"),
                  children: [
                    {
                      path: "invite",
                      lazy: () => import("./user-invite-MGQKN5D3-WON7GRRF.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./user-detail-IJFMKM7T-M2LTNCSJ.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./user-edit-XTVRRK7B-UJHEDHGQ.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./user-metadata-FGYJOHB6-5WN4E5YP.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./sales-channel-list-WH42O7JA-M6HJEQRL.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./sales-channel-create-N3WMJXT7-SI5OYBSX.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./sales-channel-detail-XVJIBVR3-CFCYCAMC.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./sales-channel-edit-F5MHMFG3-SKL3LOIV.js")
                    },
                    {
                      path: "add-products",
                      lazy: () => import("./sales-channel-add-products-72JBKLD7-5RTHDCA6.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./sales-channel-metadata-XUOVWE2X-5XKOOXEI.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./location-list-M4RYGH65-YVXTXPHA.js")
                },
                {
                  path: "create",
                  lazy: () => import("./location-create-LUP363ZB-6HGHLDQ2.js")
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./shipping-profiles-list-AUB5F6SI-MBE23OWB.js"),
                      children: [
                        {
                          path: "create",
                          lazy: () => import("./shipping-profile-create-KRMI6NUI-L7I77QGB.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./shipping-profile-detail-FDUPDSH4-FBXWEHMA.js");
                        return {
                          Component: Component4,
                          loader,
                          handle: {
                      ...
                      children: [
                        {
                          path: "metadata/edit",
                          lazy: () => import("./shipping-profile-metadata-G47QVZOP-O3W7HQQE.js")
                        }
                      ]
                    }
                  ]
                },
                {
                  path: ":location_id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./location-detail-3U4AJNOY-6IEE27KM.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./location-edit-26K26G23-JQJM7KNQ.js")
                    },
                    {
                      path: "sales-channels",
                      lazy: () => import("./location-sales-channels-EVHL5OEB-R7REGFMT.js")
                    },
                    {
                      path: "fulfillment-providers",
                      lazy: () => import("./location-fulfillment-providers-O277BKVF-WM5LOAEK.js")
                    },
                    {
                      ...
                      children: [
                        {
                          ...
                          lazy: () => import("./location-service-zone-create-6ASVPJ2T-4YUB4EJ2.js")
                        },
                        {
                          ...
                          children: [
                            {
                              path: "edit",
                              lazy: () => import("./location-service-zone-edit-74Q2BX26-UQQMPYFI.js")
                            },
                            {
                              path: "areas",
                              lazy: () => import("./location-service-zone-manage-areas-QMHNHHF6-OGZNSBSY.js")
                            },
                            {
                              ...
                              children: [
                                {
                                  path: "create",
                                  lazy: () => import("./location-service-zone-shipping-option-create-M2MIR27N-NWUNKIBZ.js")
                                },
                                {
                                  path: ":so_id",
                                  children: [
                                    {
                                      path: "edit",
                                      lazy: () => import("./location-service-zone-shipping-option-edit-CAIULPE6-BWCPRYH5.js")
                                    },
                                    {
                                      path: "pricing",
                                      lazy: () => import("./location-service-zone-shipping-option-pricing-5BAXQBBI-LMBON2U6.js")
                                    }
                                  ]
                                }
                              ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-tag-list-BQ2OY3AV-34R6WF6I.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-tag-create-KPEJXZ2Q-R3ZO5G7G.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./product-tag-detail-YOKAKUZS-KZ22AKV3.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./product-tag-edit-DEWTW4YF-JDQRZYW2.js")
                    }
                  ]
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./workflow-execution-list-WRCFDBSW-5ENCYXWZ.js")
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./workflow-execution-detail-T7Z32I2I-W7I75AHI.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./product-type-list-JM6AFTWL-O3VTKFNF.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./product-type-create-VXEOY6IV-DPTGO3HI.js")
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./product-type-detail-ZZWOVXLS-TSCVW44C.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./product-type-edit-EOBA5GJ3-GOUFDCN7.js")
                    },
                    {
                      path: "metadata/edit",
                      lazy: () => import("./product-type-metadata-5YQNX7RR-NV6H7UA6.js")
                    }
                  ]
                }
              ]
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: () => import("./api-key-management-list-GJWJDTNJ-4BPY7FCS.js"),
                      children: [
                        {
                          path: "create",
                          lazy: () => import("./api-key-management-create-CMDHXLLL-BPLOKMA4.js")
                        }
                      ]
                    }
                  ]
                },
                {
                  path: ":id",
                  lazy: async () => {
                    const { Component: Component4, Breadcrumb, loader } = await import("./api-key-management-detail-QDITLDDQ-Y5HBLKLV.js");
                    return {
                      Component: Component4,
                      loader,
                      handle: {
                  ...
                  children: [
                    {
                      path: "edit",
                      lazy: () => import("./api-key-management-edit-55YWPC5T-FUKRSCPR.js")
                    },
                    {
                      path: "sales-channels",
                      lazy: () => import("./api-key-management-sales-channels-JV2Q2NR2-AR4HKFFU.js")
                    }
                  ]
                }
              ]
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./tax-region-list-WLTMUWAT-KFVIHVTV.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./tax-region-create-GE55U7Q4-KOYAXDGV.js")
                    }
                  ]
                },
                {
                  ...
                  children: [
                    {
                      path: "",
                      lazy: async () => {
                        const { Component: Component4 } = await import("./tax-region-detail-WCYWAVKW-MRCRYQ4S.js");
                        return {
                          Component: Component4
                        };
                      },
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./tax-region-edit-BYT6D6FL-3ZIQ3AAN.js")
                        },
                        {
                          path: "provinces/create",
                          lazy: () => import("./tax-region-province-create-FFXYN7M4-ZLGY5ZHN.js")
                        },
                        {
                          path: "overrides/create",
                          lazy: () => import("./tax-region-tax-override-create-K2VQJ6OH-3BUDRDIW.js")
                        },
                        {
                          path: "overrides/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-override-edit-5IJ7WH7L-D4OK7WX7.js")
                        },
                        {
                          path: "tax-rates/create",
                          lazy: () => import("./tax-region-tax-rate-create-T2FKYRNI-UKIV4AYT.js")
                        },
                        {
                          path: "tax-rates/:tax_rate_id/edit",
                          lazy: () => import("./tax-region-tax-rate-edit-VACYUP6R-ZUZUNCNQ.js")
                        }
                      ]
                    },
                    {
                      ...
                      lazy: async () => {
                        const { Component: Component4, Breadcrumb, loader } = await import("./tax-region-province-detail-6X46BRIN-SUIAWIER.js");
                        return {
                          Component: Component4,
                          loader,
                          handle: {
            ...
            },
            {
              ...
              children: [
                {
                  path: "",
                  lazy: () => import("./return-reason-list-2SJ6WMWT-KHBJPJFG.js"),
                  children: [
                    {
                      path: "create",
                      lazy: () => import("./return-reason-create-TFLUQVJH-YWGN24IL.js")
                    },
                    {
                      path: ":id",
                      children: [
                        {
                          path: "edit",
                          lazy: () => import("./return-reason-edit-WN3KGPRR-6O2EWKLA.js")
                        }
                      ]
                    }
                  ]
      ...
      children: [
        {
          ...
          children: [
            {
              path: "/login",
              lazy: () => import("./login-7WGNCEWP-RRNQJRW6.js")
            },
            {
              path: "/reset-password",
              lazy: () => import("./reset-password-FWHPV6WF-MIG56XQI.js")
            },
            {
              path: "/invite",
              lazy: () => import("./invite-IQITJV62-PLEWHEXQ.js")
            },
            {
              path: "*",
              lazy: () => import("./no-match-KSAPNRPO-FSRIGZIT.js")
            }
          ]
        }
      ]
...
//# sourceMappingURL=chunk-ETTKLSZV.js.map
